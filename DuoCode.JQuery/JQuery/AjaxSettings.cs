...
namespace DuoCode.JQuery
{
    ...
    {
        [Js(Name = "beforeSend")] private Action<JqXHR, AjaxSettings> beforeSend;
        [Js(Name = "context")] private HTMLElement context;
        [Js(Name = "data")] private Dictionary<string, string> data;
        [Js(Name = "dataType")] private AjaxDataType dataType;
        [Js(Name = "headers")] private Dictionary<string, string> headers;
        [Js(Name = "async")] private bool isAsync;
        [Js(Name = "cache")] private bool isCached;
        [Js(Name = "crossDomain")] private bool isCrossDomain;
        [Js(Name = "complete")] private Action<JqXHR, string> onComplete;
        [Js(Name = "error")] private Action<JqXHR, AjaxErrorTextStatus?, string> onError;
        [Js(Name = "success")] protected Action<dynamic, string, JqXHR> OnSuccessDynamic;
        [Js(Name = "password")] private string password;
        [Js(Name = "timeout")] private string timeoutString;
        [Js(Name = "type")] private string type;
        [Js(Name = "url")] private string url;
        [Js(Name = "global")] private bool useGlobalAjaxEventHandlers;
        [Js(Name = "username")] private string username;
